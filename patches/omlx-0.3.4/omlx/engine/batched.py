...
class BatchedEngine(BaseEngine):
    ...
    async def stop(self) -> None:
        ...
        if self._engine:
            ...
            # swap-safe: Protected close() to release scheduler, paged cache,
            # and model-bound Metal buffers. Without this, KV cache and
            # paged cache blocks remain allocated after unload.
